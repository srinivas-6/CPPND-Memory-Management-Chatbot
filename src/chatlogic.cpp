                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                           ...
                           // pass raw pointers to avoid ownership
                            ...
                            (*childNode)->AddEdgeToParentNode(edge.get()); // non owning ref
                            (*parentNode)->AddEdgeToChildNode(std::move(edge)); // owning ref
                        }
